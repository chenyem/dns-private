...
export const TAURI_CONF_PATH = path.join(
  ROOT_PATH,
  "src-tauri",
  "tauri.conf.json"
);
export const UPDATER_JSON_PATH = path.join(
  ROOT_PATH,
  "updater",
  "install.json"
);
export const RELEASE_YML_PATH = path.join(
  ROOT_PATH,
  ".github",
  "workflows",
  "release.yml"
...
export const relativePath = (p) =>
  `${p.split(ROOT_PATH)?.[1].substring(1)}` || "";
